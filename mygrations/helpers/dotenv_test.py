...
class DotEnvTest(unittest.TestCase):
    ...
    def test_get_contents_stringIO(self):
        ...
        self.assertEqual(self.test_string, self.dotenv.get_contents(io.StringIO(self.test_string)))

    # it should also accept an actual string
    def test_get_contents_string(self):

        self.assertEqual(self.test_string, self.dotenv.get_contents(self.test_string))
    ...
    def test_get_contents_fp(self):
        ...
        fp.seek(0)
        self.assertEqual(self.test_string, self.dotenv.get_contents(fp))
        fp.close()
    ...
    def test_get_contents_filename(self):
        ...
        self.assertEqual(self.test_string, self.dotenv.get_contents(filename))
    ...
    def test_json(self):
        ...
        self.assertEqual({'key': 'value', 'name': 'bob'}, parsed)
    ...
    def test_parse_skip_empty(self):
        ...
        self.assertEqual({'key': 'value', 'name': 'bob', 'another': 'test"value'}, parsed)

    def test_opening_comment(self):

        self.assertEqual([False, False], self.dotenv.parse_line('# name = test', '#'))
    ...
    def test_multi_character_comment(self):
        ...
        self.assertEqual([False, False], self.dotenv.parse_line('weirdcomment name = test', 'weirdcomment'))

    def test_ignore_empty_lines(self):

        # empty lines (which includes lines with all white space) are ignored
        self.assertEqual([False, False], self.dotenv.parse_line('  ', '#'))
    ...
    def test_empty_value_equal(self):
        ...
        self.assertEqual(['key', ''], self.dotenv.parse_line('key=', '#'))
    ...
    def test_value_no_quotes_equal(self):
        ...
        self.assertEqual(['key', 'asdf'], self.dotenv.parse_line("key=asdf", '#'))
    ...
    def test_value_no_quotes_equal_spaces(self):
        ...
        self.assertEqual(['key', 'asdf bob'], self.dotenv.parse_line("key= asdf bob  \t", '#'))
    ...
    def test_value_no_quotes_equal_comment(self):
        ...
        self.assertEqual(['key', 'asdf bob'], self.dotenv.parse_line("key = asdf bob  \t# a comment", '#'))
    ...
    def test_empty_single(self):
        ...
        # easy
        self.assertEqual(['db', ''], self.dotenv.parse_line("db = ''", '#'))
    ...
    def test_empty_single_comment(self):
        ...
        # easy
        self.assertEqual(['db', ''], self.dotenv.parse_line("db = '' # database name", '#'))
    ...
    def test_single_quotes(self):
        ...
        # be ignored still
        self.assertEqual(['db', 'dijere'], self.dotenv.parse_line("db = 'dijere' ", '#'))
    ...
    def test_double_quotes_with_comment(self):
        ...
        self.assertEqual(['db', 'bob'], self.dotenv.parse_line('db = "bob" ; database name', ';'))
    ...
    def test_allow_ending_semicolon(self):
        ...
        self.assertEqual(['name', 'test'], self.dotenv.parse_line("name = 'test';", '#'))

    def test_escaped_single_quote(self):

        # quotes can be escaped inside quotes
        self.assertEqual(['db', "asdf'qwerty'"], self.dotenv.parse_line("db = 'asdf\\'qwerty\\''", '#'))
    ...
    def test_preserve_other_slashes(self):
        ...
        self.assertEqual(['db', 'asdf\\bob'], self.dotenv.parse_line('db = "asdf\\bob"', '#'))
