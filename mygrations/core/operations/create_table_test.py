...
class CreateTableTest(unittest.TestCase):
    def test_as_string(self):
        ...
        self.assertEquals("""CREATE TABLE `test_table` (
  `id` INT(10) UNSIGNED AUTO_INCREMENT,
  `name` VARCHAR(255),
  PRIMARY KEY `id` (`id`)
) ENGINE=InnoDB;""", str(CreateTable(table, True)))
        self.assertEquals("""CREATE TABLE `test_table` (`id` INT(10) UNSIGNED AUTO_INCREMENT,`name` VARCHAR(255),PRIMARY KEY `id` (`id`)) ENGINE=InnoDB;""", str(CreateTable(table, False)))
