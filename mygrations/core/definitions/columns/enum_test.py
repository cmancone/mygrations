...
class TestEnum(unittest.TestCase):
    def test_string_conversion(self):
        ...
        self.assertEqual("`test_column` ENUM('asdf', 'qwerty') DEFAULT \'qwerty\'", str(column))
    ...
    def test_default_errors(self):
        ...
        self.assertEqual(["Default value for 'ENUM' column 'test_column' is not in the list of allowed values"],
                          column.schema_errors)

        self.assertEqual([], Enum('test_column', 'ENUM', enum_values=['asdf', 'qwerty']).schema_errors)
